...
Deno **199**、Bun **189** 全部通过。包覆盖服务端文件路由（含特异性排序、扁平 API
`:method` 动态段及嵌套 **`_middleware` 链**）、客户端导航与 **`nav-match`**
辅助函数、浏览器集成与核心匹配逻辑。

---

**报告生成**：2026-06-27 **环境**：Deno + Bun + Puppeteer
