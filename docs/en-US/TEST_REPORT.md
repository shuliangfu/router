...
- ✅ start link interception (same-origin, external, target=_blank, modifier
  keys, etc.)
- ✅ destroy
...
@dreamer/router has 100% test coverage with all 130 tests passing. Supports
Preact and React rendering engines, covering server-side route scan/match and
client-side route navigation/guards/link interception.

---

**Report generated**: 2026-02-03 **Test environment**: Deno + Bun + Puppeteer
